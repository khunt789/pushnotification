...
app.controller('AppCtrl', function($scope, $cordovaPush, $cordovaDialogs, $cordovaMedia, $cordovaToast, ionPlatform, $http) {
    ...
    function storeDeviceToken(type) {
        ...
        $http.post('http://localhost/pdemo/PushNotificationSample-master/subscribe', JSON.stringify(user))
    ...
    function removeDeviceToken() {
        ...
        $http.post('http://localhost/pdemo/PushNotificationSample-master/unsubscribe', JSON.stringify(tkn))
            .success(function (data, status) {
